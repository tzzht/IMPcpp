...
#line 154 "parser.cpp"
    ...
    : super_type (YY_MOVE (that.state), YY_MOVE (that.location))
  {
    switch (that.type_get ())
    {
      ...
      case 33: // aexp
        value.YY_MOVE_OR_COPY< tzzht::AVar * > (YY_MOVE (that.value));
        break;

      case 34: // bexp
        value.YY_MOVE_OR_COPY< tzzht::BVar * > (YY_MOVE (that.value));
        break;

      case 35: // statement
        value.YY_MOVE_OR_COPY< tzzht::Statement * > (YY_MOVE (that.value));
        break;
    ...
    : super_type (s, YY_MOVE (that.location))
  {
    switch (that.type_get ())
    {
      ...
      case 33: // aexp
        value.move< tzzht::AVar * > (YY_MOVE (that.value));
        break;

      case 34: // bexp
        value.move< tzzht::BVar * > (YY_MOVE (that.value));
        break;

      case 35: // statement
        value.move< tzzht::Statement * > (YY_MOVE (that.value));
        break;
   ...
   Parser ::stack_symbol_type::operator= (const stack_symbol_type& that)
  {
    ...
    switch (that.type_get ())
    {
      ...
      case 33: // aexp
        value.copy< tzzht::AVar * > (that.value);
        break;

      case 34: // bexp
        value.copy< tzzht::BVar * > (that.value);
        break;

      case 35: // statement
        value.copy< tzzht::Statement * > (that.value);
        break;
   ...
   Parser ::stack_symbol_type::operator= (stack_symbol_type& that)
  {
    ...
    switch (that.type_get ())
    {
      ...
      case 33: // aexp
        value.move< tzzht::AVar * > (that.value);
        break;

      case 34: // bexp
        value.move< tzzht::BVar * > (that.value);
        break;

      case 35: // statement
        value.move< tzzht::Statement * > (that.value);
        break;
  ...
  yyreduce:
      ...
      switch (yyr1_[yyn])
    {
      ...
      case 33: // aexp
        yylhs.value.emplace< tzzht::AVar * > ();
        break;

      case 34: // bexp
        yylhs.value.emplace< tzzht::BVar * > ();
        break;

      case 35: // statement
        yylhs.value.emplace< tzzht::Statement * > ();
        break;
...
#line 110 "parser.y"
                { 
        cout << "*** PARSER BEGIN ***" << endl;
        driver.Init(yystack_[0].value.as < tzzht::Statement * > ());
...
#undef YYCASE_
  ...
  {
  "END", "error", "$undefined", "IDENTIFER", "NUMBER", "PLUS", "MINUS",
  "TIMES", "TRUE", "FALSE", "EQUAL", "LAE", "NOT", "CONJUNCTION",
  "DISCONJUNCTION", "COBEGIN", "CONCUR", "COEND", "SKIP", "ASSIGNMENT",
  "SEMICOLON", "WAIT", "LPAREN", "RPAREN", "IF", "THEN", "ELSE", "ENDIF",
  "WHILE", "DO", "ENDDO", "$accept", "process", "aexp", "bexp",
